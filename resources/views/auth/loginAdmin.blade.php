...
@section('content')
    ...
    <form class="max-w-sm mx-auto" method = "POST" action = "{{route('login')}}" novalidate>
        ...
        <div class="flex justify-center mb-5">
            <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-none text-sm px-5 py-2.5 text-center dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-900">Iniciar sesión</button>
        </div>
