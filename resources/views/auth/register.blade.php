    ...
    <div class="max-w-sm mx-auto">
        ...
        <form id="registrationForm" class="max-w-sm mx-auto" method="POST" action="{{ route('registerCreate') }}" novalidate>
            ...
            <div class="mb-5 flex items-center justify-center">
                <a href="{{route('registerForm')}}" class="flex items-center justify-center">
            ...
            <div class="mb-5">
                ...
                <input type="email" id="email" name="email" maxlength = "255" class="shadow-sm  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="nombre@dominio.com" required />
                @error('email')
            ...
            <div class="mb-5">
                ...
                <input type="text" name="name" id="name" maxlength = "255" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
                @error('name')
                <p class="bg-red-500 text-white my-2 rounded-lg text-lg text-center p-2">{{ $message }}</p>
                @enderror
            </div>
